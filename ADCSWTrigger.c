...
// ain9 (PE4) 0 to 4095
// ain8 (PE5) 0 to 4095
void ADC0_InSeq3(float *pwm, unsigned long *irL, unsigned long *irR){
  ADC0_PSSI_R = 0x0004;            // 1) initiate SS2
  while((ADC0_RIS_R&0x04)==0){};   // 2) wait for conversion done
  *pwm = ADC0_SSFIFO2_R&0xFFF;    // 3A) read first result
  *irL = ADC0_SSFIFO2_R&0xFFF;    // 3B) read second result
  *irR = ADC0_SSFIFO2_R&0xFFF;    // 3C) read third result
